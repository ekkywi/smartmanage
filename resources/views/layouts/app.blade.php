...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li>
                            ...
                            <ul class="collapse nav flex-column ml-3" data-parent="#menu" id="submenu1">
                                <li class="w-100">
                                    <a class="nav-link px-0" href="{{ route("aset") }}"> <span class="d-none d-sm-inline">Kelola Data Aset</span></a>
                                </li>
                            </ul>
                        </li>
                        <li>
                    ...
                    <div class="dropdown pb-4">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
                            <li><a class="dropdown-item" href="{{ route("profile") }}">Ganti Password</a></li>
            ...
            <div class="col py-3 col-md-10 col-xl-10">
                @yield("content")
            </div>
        </div>
    </div>
